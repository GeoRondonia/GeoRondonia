...
class geradordeods(QgsProcessingAlgorithm):
	...
	def processAlgorithm(self, parameters, context, feedback):
        ...
        # ------------------------------------------------------
		#Parei aqui
		for feature in parcela.getFeatures():
			output_path = self.parameterAsString(parameters, self.OUTPUT, context)
			parcela_id = feature['denominacao']  # Supondo que 'id' seja um campo único para cada parcela
			unique_output_path = f"{output_path[:-4]}_{parcela_id}.ods"  # Adiciona o ID da parcela ao nome do arquivo
			...
			for n, pol in enumerate(polygons):
				...
				data = data.replace('output_path', unique_output_path)
