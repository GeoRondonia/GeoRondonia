...
__date__ = '2023-03-12'
__copyright__ = '(C) 2023, Leandro França e Maik Rodrigues de Souza'
...
from ..geocapt.cartography import OrientarPoligono
import numpy as np
import os
...
class AdjoinerLine(QgsProcessingAlgorithm):
    ...
    figure1 = 'images/tutorial/cadastre_adjoiners.jpg'
